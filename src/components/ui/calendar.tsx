...
import { Button, buttonVariants } from "../../features/clerk-desk/components/wordpro/components/ui/button";
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 [--cell-size:calc(var(--spacing,0.25rem)*8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
