...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "../../features/clerk-desk/components/wordpro/components/ui/sheet";
import { Skeleton } from "../../features/clerk-desk/components/wordpro/components/ui/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(calc(var(--spacing,0.25rem)*4)))]"
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(calc(var(--spacing,0.25rem)*4))+2px)]"
