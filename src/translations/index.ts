...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    pension: {
      ...
      subtitle: 'KPK Rules 2026 Notification',
    ...
    budgeting: {
      ...
      subtitle: 'Manage Source I-III, TA Bills, and Budget Proposals',
      ...
      rbdcDesc: 'Automatically compile establishment costs, utility charges, and developmental budget items into official KPK government formats.',
    },
    legalAudit: {
      title: 'Legal & Audit Monitoring',
      subtitle: 'Track Court Cases and Audit Paras',
    ...
    admin: {
      ...
      subtitle: 'Manage seniority, transfers, medical claims, and loans',
      ...
      medicalDesc: 'Process medical reimbursement claims according to KPK health department standards.',
      ...
      vehicleLoanDesc: 'Process car/motorcycle loan applications with pre-defined KPK government formats.',
      ...
      rulesBasedSeniorityDesc: 'Lists are automatically generated based on BPS, Date of Regularization, and length of service as per KP Civil Servant Rules.',
      kpPayScaleLogic: 'KP Revised Pay Scales 2022 Logic',
    ...
    templates: {
      govtKP: 'GOVERNMENT OF KHYBER PAKHTUNKHWA',
      no: 'No.',
      dated: 'Dated',
      to: 'To',
      subject: 'Subject',
  ...
  ur: {
    ...
    pension: {
      ...
      subtitle: 'کے پی کے رولز 2026 نوٹیفکیشن',
    ...
    budgeting: {
      ...
      subtitle: 'سورس I-III، ٹی اے بلز اور بجٹ تجاویز کا انتظام کریں',
      ...
      rbdcDesc: 'اسٹیبلشمنٹ کے اخراجات، یوٹیلیٹی چارجز اور ترقیاتی بجٹ کی اشیاء کو خودکار طور پر سرکاری KPK فارمیٹس میں مرتب کریں۔',
    },
    legalAudit: {
      title: 'قانونی اور آڈٹ مانیٹرنگ',
      subtitle: 'عدالتی کیسز اور آڈٹ پیراز کی ٹریکنگ',
    ...
    admin: {
      ...
      subtitle: 'سینیارٹی، تبادلے، طبی کلیمز اور قرضوں کا انتظام کریں',
      ...
      medicalDesc: 'کے پی کے محکمہ صحت کے معیار کے مطابق میڈیکل ری ایمبرسمنٹ کلیمز پر کارروائی کریں۔',
      ...
      vehicleLoanDesc: 'سرکاری کے پی کے فارمیٹس کے ساتھ کار/موٹر سائیکل لون کی درخواستوں پر کارروائی کریں۔',
      ...
      rulesBasedSeniorityDesc: 'کے پی سول سرونٹ رولز کے مطابق بی پی ایس، ریگولرائزیشن کی تاریخ اور مدت ملازمت کی بنیاد پر فہرستیں خودکار طور پر تیار کی جاتی ہیں۔',
      kpPayScaleLogic: 'کے پی ریوائزڈ پے اسکیلز 2022',
